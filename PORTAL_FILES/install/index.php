...
include("src/func/language_install.php");
$_language = new Language_Install();
...
<table border="0" cellpadding="0" cellspacing="0" width="776" align="center">
	<center><img src="http://vk.xterium.ru/media/images/xterium_logo.png" style="align:center;"></center>
   <?php
